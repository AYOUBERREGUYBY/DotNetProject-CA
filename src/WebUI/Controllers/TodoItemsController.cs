using REpo_gIt.Application.Common.Models;
using REpo_gIt.Application.TodoItems.Commands.CreateTodoItem;
using REpo_gIt.Application.TodoItems.Commands.DeleteTodoItem;
using REpo_gIt.Application.TodoItems.Commands.UpdateTodoItem;
using REpo_gIt.Application.TodoItems.Commands.UpdateTodoItemDetail;
using REpo_gIt.Application.TodoItems.Queries.GetTodoItemsWithPagination;
